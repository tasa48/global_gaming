...
// Comprobar si existe el parámetro de logout en la URL
...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-light barra">
    <a class="navbar-brand" href="index.php"> <img src="vista/img/G.png"></a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item">
          <a class="nav-link" href="vista/formulario-login.php">Login</a>
        </li>
      </ul>
        ...
        <div class="modal-body">
          ...
          <div class="modal-body">
            <form method="POST" action="controlador/login.php">
              ...
              <a href="registro2.php" class="btn btn-primary">Registrarse</a>
